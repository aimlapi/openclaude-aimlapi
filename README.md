...
- AI/ML API uses the OpenAI-compatible route, defaults to `gpt-4o`, supports passwordless guided onboarding/top-up, and only surfaces chat-capable models from its public catalog
